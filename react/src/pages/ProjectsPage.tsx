        ...
        <div className="row py-lg-5">
          <div className="col-lg-6 col-md-8 mx-auto">
            ...
            <p className="lead text-muted">
              I created this page to show how react can be integrated into a
              static website.
            </p>
            <p className="lead text-muted">
              This section of the site uses both React for frontend rendering
              and Bootstrap for front end styling, and recreates my project
              section using these technologies.
            </p>
          </div>
        </div>
      </section>
